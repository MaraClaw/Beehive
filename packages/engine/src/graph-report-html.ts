...
<title>Beehive Graph Report</title>
<style>
:root {
  --bg: #0f172a;
  --surface: #1e293b;
...
<footer>Generated by Beehive &middot; ${graph.nodes.length} nodes &middot; ${graph.edges.length} edges &middot; ${graph.pages.length} pages</footer>
